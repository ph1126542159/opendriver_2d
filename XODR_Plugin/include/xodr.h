...
#if defined(xodr_LIBRARY)
#  define xodrSHARED_EXPORT __declspec(dllexport)
#else
#  define xodrSHARED_EXPORT __declspec(dllimport)
#endif
...
public:
    _OpenDriveElement(){};
    _OpenDriveElement(pugi::xml_node ){};
