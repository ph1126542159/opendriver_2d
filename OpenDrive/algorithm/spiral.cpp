...
double Spiral::polevl( double x, double* coef, int n )
{
    double ans;
    double *p = coef;
    int i;
...
double Spiral::p1evl( double x, double* coef, int n )
{
    double ans;
    double *p = coef;
    int i;
...
void Spiral::fresnel( double xxa, double *ssa, double *cca )
{
...
void Spiral::calculateSpiral( double s, double cDot, double *x, double *y, double *t )
{
    double a;
